...
function addMarker(customValue, iconsize) {
    ...
    var iconsizeM = document.getElementById("iconsizeM").value;
    ...
    marker.on('dragend', function () {
        ...
        if (index !== -1) {
            ...
            markers.push({ 'id': marker.getElement().id, 'icontype': marker.getElement().getAttribute("aria-label"), 'lnglat': marker.getLngLat(), 'iconsize': iconsizeM });
        }
...
function addMarkeraf(customValue, iconsize) {
    ...
    var iconsizeA = document.getElementById("iconsizeA").value;
    ...
    markeraf.on('dragend', function () {
        ...
        if (index !== -1) {
            ...
            // Add the new marker to the markers array
            markersaf.push({ 'id': markeraf.getElement().id, 'icontype': markeraf.getElement().getAttribute("aria-label"), 'lnglat': markeraf.getLngLat(), 'iconsize' : iconsizeA });
        }
...
function addMarkerev(customValue, iconsize) {
    ...
    var iconsizeE = document.getElementById("iconsizeE").value;
    ...
    markerev.on('dragend', function () {
        ...
        if (index !== -1) {
            ...
            // Add the new marker to the markers array
            markersev.push({ 'id': markerev.getElement().id, 'icontype': markerev.getElement().getAttribute("aria-label"), 'lnglat': markerev.getLngLat(), 'iconsize' : iconsizeE });
        }
    ...
    // Add the new marker to the markers array
    markersev.push({ 'id': markerev.getElement().id, 'icontype': markerev.getElement().getAttribute("aria-label"), 'lnglat': markerev.getLngLat(),'iconsizeE' : iconsizeE });
}
