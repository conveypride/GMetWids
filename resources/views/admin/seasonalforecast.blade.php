	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">Seasonal Forecast</h1>
				    </div>
				    <div class="col-auto">
					     <div class="page-utilities">
						    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
							    ...
							    <div class="col-auto">						    
								    <a class="btn app-btn-secondary" href="{{ route('seasonalforecastUpload') }}">
							    ...
							    <div class="table-responsive">
							        <table class="table app-table-hover mb-0 text-left">
										<thead>
											<tr>
												<th class="cell">Id</th>
												<th class="cell">Forecast Time-Frame</th>
                                                <th class="cell">Sumarry</th>
										...
										<tbody>
											@forelse ($seasonalForecasts as $seasonalForecast)
												<tr>
												<td class="cell">{{ $seasonalForecast->seasonalId }}</td>
												<td class="cell">
                                                    {{ $seasonalForecast->datestart }}
                                                    	<=> 
                                                        {{ $seasonalForecast->dateend }}
												</td>
                                                <td class="cell"><span class="truncate">
                                                    {{ $seasonalForecast->summary }} 
												</span></td>

												<td class="cell">{{  $seasonalForecast->forecaster }}</td>
												<td class="cell"><span>{{ \Carbon\Carbon::parse($seasonalForecast->created_at)->format('j, M') }}</span><span class="note">{{ \Carbon\Carbon::parse($seasonalForecast->created_at)->format('h:i A') }}</span></td>
											...
											@empty
												<tr><td><p> No Seasonal Forecast Available</p> </td><tr>
											@endforelse
