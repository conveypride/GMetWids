				    ...
				    <div class="col-auto">
					     <div class="page-utilities">
						    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
							    ...
							    <div class="col-auto">						    
								    <a class="btn app-btn-secondary" href="{{ route('addNewDf') }}">
						    ...
						    <div class="app-card-body">
							    <div class="table-responsive">
							        <table class="table app-table-hover mb-0 text-left">
										...
										<tbody>
											@forelse ($dailyforecasts as $dailyforecast)
												<tr>
												<td class="cell">{{ $dailyforecast->id }}</td>
												<td class="cell"><span class="truncate">{{ $dailyforecast->summary }}</span></td>
												<td class="cell">{{  $dailyforecast->creator }}</td>
												<td class="cell"><span>{{ \Carbon\Carbon::parse($dailyforecast->created_at)->format('j, M') }}</span><span class="note">{{ \Carbon\Carbon::parse($dailyforecast->created_at)->format('h:i A') }}</span></td>
												<td class="cell"><span class="@if ($dailyforecast->publishType == 'Publish-Forecast')badge bg-success @elseif ($dailyforecast->publishType == 'Draft-Forecast') badge bg-warning @else badge bg-danger @endif">
