             ...
             <div class="container-xl">
											...
											@if (!empty($dailyforecasts))
                                             ...
                                             @foreach ($dailyforecasts as $dailyforecast)
                                                 <tr>
                                                     ...
                                                     {{-- <td class="cell">$259.35</td> app-card-actions --}}
                                                     <td class="cell">
                                                         <div class="dropdown">
				 ...
				 <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
												...
												@else
													<tr>
														<td>
															<p> No Pending Forecast Available</p>
														</td>
													<tr>
												@endif
				  ...
				  <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
                                                 ...
                                                 @else
                                                     <tr>
                                                         <td>
                                                             <p> No Published Forecast Available</p>
                                                         </td>
                                                     <tr>
                                                 @endif
				  ...
				  <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
                                                 ...
                                                 @else
                                                     <tr>
                                                         <td>
                                                             <p> No Drafted Forecast Available</p>
                                                         </td>
                                                     <tr>
                                                 @endif
				  ...
				  <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
                                                 ...
                                                 @else
                                                     <tr>
                                                         <td>
                                                             <p> No Deleted Forecast Available</p>
                                                         </td>
                                                     <tr>
                                                 @endif
