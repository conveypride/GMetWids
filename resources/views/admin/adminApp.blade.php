      ...
      <path fill-rule="evenodd" d="M8 5.754a2.246 2.246 0 1 0 0 4.492 2.246 2.246 0 0 0 0-4.492zM4.754 8a3.246 3.246 0 1 1 6.492 0 3.246 3.246 0 0 1-6.492 0z"/>
            ...
            <div id="app-sidepanel" class="app-sidepanel"> 
                ...
                <div class="sidepanel-inner d-flex flex-column">
                    ...
                    <div class="app-branding">
                        <a class="app-logo" href="{{ route('home') }}"><img class="logo-icon me-2" src="{{ asset('images/icon.png') }} " alt="logo"><span class="logo-text">GMet</span></a>
          ...
          <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
                                ...
                                <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                                    <ul class="submenu-list list-unstyled">
                                        <li class="submenu-item"><a class="submenu-link" href= "{{ route('df') }}">Daily-Forecast</a></li>
                                        <li class="submenu-item"><a class="submenu-link" href="{{ route('fiveDayForecast') }}">5-Days-Forecast</a></li>
                                        <li class="submenu-item"><a class="submenu-link" href="#">Marine-Forecast</a></li>
                                    </ul>
                                </div>
                            </li><!--//nav-item-->
          ...
          <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
                                ...
                                <div id="submenu-2" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                                    <ul class="submenu-list list-unstyled">
                                        <li class="submenu-item"><a class="submenu-link" href="{{ route('cafoDistricts') }}">Add District(CAFO)</a></li>
                                        <li class="submenu-item"><a class="submenu-link" href="#">Marine District</a></li>
