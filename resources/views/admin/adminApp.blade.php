...
<head>
    ...
    @yield('generatePDFCss')
    @yield('marinedistrictCss')
    @yield('marineforecasteCss')
    @yield('inlandforecasteCss')
    {{-- inject css file of ADDrainTemp here csss  --}}
    @yield('rainTempCss')
    @yield('seasonalforecastCss')
    @yield('css')
</head>
</head>
                            ...
                            <div class="app-utilities col-auto">
                                ...
                                <div class="app-utility-item app-user-dropdown dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
                                        ...
                                        <li><a class="dropdown-item"> <a class="dropdown-item"
                                                    href="{{ route('logout') }}"
                                                    onclick="event.preventDefault();
                                                      document.getElementById('logout-form').submit();">
                                                    {{ __('Logout') }}
                            ...
                            <li class="nav-item has-submenu">
                                ...
                                <div id="submenu-1" class="collapse submenu submenu-1"
                                    ...
                                    <ul class="submenu-list list-unstyled">
                                        ...
                                        <li class="submenu-item"><a class="submenu-link"
                                                href="{{ route('fiveDayForecast') }}">5-Days-Forecast</a></li>
                                        <li class="submenu-item"><a class="submenu-link"
                                                href="{{ route('rainTempUpload') }}">5-Days Spatial Rain & Temp.</a>
                                        </li>
                                        <li class="submenu-item"><a class="submenu-link"
...
{{-- end of weekly outlook --}}
    ...
    @yield('marinedistrictJs')
    @yield('fivedayForecastJs')
    @yield('rainTempJs')
    @yield('marineforecasteJs')
    @yield('inlandforecasteJs')
    @yield('seasonalforecastJs')
    @yield('script')
</body>
