...
<div class="row mt-2">
    <div class="col-2"></div>
    <div class="col-8 fw-bold text-dark text-center"  style="font-size: 18px; text-decoration:underline;">INLAND WATER IMPACT-BASED FORECAST</div>
    <div class="col-2"></div>
</div>
...
<div class="col-2 mx-0 px-0">
   ...
   <tbody>
            ...
            <tr><td scope="row">06: 00 AM</td></tr>
...
<div class="col-2 mx-0 px-0">
    ...
    <tr><th scope="col">CAFO</th></tr>
        ...
        <tbody>
            ...
            <tr><td scope="row">{{ \Carbon\Carbon::parse($addDailyForecast['updated_at'])->format('H:i') }} UTC</td></tr>
            <tr> <td scope="row" class="bg-dark text-white">Valid From</td></tr>
            <tr><td scope="row">12: 00 PM</td></tr>
            <tr> <td scope="row" class="bg-dark text-white">Nowcasting Risk</td></tr>
            <tr> <th class="text-center" style="background-color:#ff0000">Take Action</th> </tr> 
         </tr><th  class="text-center" style="background-color: #e9f542">Be Aware</th></tr>
         </tr><th class="text-center" style="background-color: #4ca64c">Low Risk</th></tr>
...
<div class="col-2 mx-0 px-0">
    ...
    <tr><th scope="col">CAFO</th></tr>
        ...
        <tbody>
            ...
            <tr><td scope="row">{{ \Carbon\Carbon::parse($addDailyForecast['updated_at'])->format('H:i') }} UTC</td></tr>
            <tr> <td scope="row" class="bg-dark text-white">Valid From</td></tr>
            <tr><td scope="row">06: 00 PM</td></tr>
            <tr> <td scope="row" class="bg-dark text-white">Nowcasting Risk</td></tr>
            <tr> <th class="text-center" style="background-color:#ff0000">Take Action</th> </tr> 
         </tr><th  class="text-center" style="background-color: #e9f542">Be Aware</th></tr>
         </tr><th class="text-center" style="background-color: #4ca64c">Low Risk</th></tr>
    ...
    <table class="table table-bordered text-dark border-dark" id="legend" style="font-size: 10px">
        <tbody style="font-size: 15px">
           ...
           <tr class="text-center fw-bold httr" >
                ...
                <td  style="background-color:rgb(247, 247, 164); text-align:center">{{ $addDailyForecast['i24hoursurfacewind'] }}</td>
                <td  style="background-color:rgb(247, 247, 164); text-align:center">{{ $addDailyForecast['i24hourvisibility'] }}</td>
                <td  style="background-color:rgb(247, 247, 164); text-align:center">{{ $addDailyForecast['i24hourtemp'] }}°C</td>
            </tr>
            <tr class="text-center fw-bold httr">
                <td  style="background-color:gold" scope="row">48 Hours</td>
                <td  style="background-color:rgb(247, 247, 164); text-align:center">{{ $addDailyForecast['i48hoursurfacewind'] }}</td>
                <td  style="background-color:rgb(247, 247, 164); text-align:center">{{ $addDailyForecast['i48hourvisibility'] }}</td>
                <td  style="background-color:rgb(247, 247, 164); text-align:center">{{ $addDailyForecast['i48hourtemp'] }}°C</td>
            </tr>
  </tbody>
    </table>
</div>
...
<script src="{{ asset('assets/js/generateInlandmap.js') }}"></script>
