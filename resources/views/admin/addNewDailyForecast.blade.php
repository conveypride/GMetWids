        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <nav id="orders-table-tab" class="orders-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4">
                    ...
                    <a class="flex-sm-fill text-sm-center nav-link disabled" id="map-tab" data-bs-toggle="tab"
                        href="#map" role="tab" aria-controls="map" aria-selected="false">Map</a>


                    <a class="flex-sm-fill text-sm-center nav-link disabled" id="weatherSummary-tab" data-bs-toggle="tab"
                        href="#weatherSummary" role="tab" aria-controls="weatherSummary"
                        aria-selected="false">Summary</a>
                    <a class="flex-sm-fill text-sm-center nav-link disabled" id="weatherWarning-tab" data-bs-toggle="tab"
                        href="#weatherWarning" role="tab" aria-controls="weatherWarning"
                        aria-selected="false">Weather-Warning</a>
                </nav>
                <div class="tab-content" id="orders-table-tab-content">
                                            ...
                                            <th colspan="7">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        ...
                                                        {{-- value="{{ !empty($genMorning)  ? $genMorning->date : '' }}"> --}}
                                                    </div>

                                                    <div class="col-6">
                                                        <label for="itdtableMorning" class="form-label">Set ITD
                                                            Position</label>
                                                        <input type="number" class="form-control required"
                                                            id="itdtableMorning" placeholder="e.g: 1"
                                                            value="{{ !empty($genMorning) ? $genMorning->itd : '' }}">
                                                    </div>
                                                </div>
                                            </th>
                                        </tr>
                                                    ...
                                                    @if (!empty($missingmorningcities))
                                                        @foreach ($missingmorningcities as $missingmorningcitie)
                                                            @if ($district->districtname == $missingmorningcitie)
                                                                <tr class="morning"
                                                                    districtnam="{{ $district->districtname }}">
                                                                    <td>{{ $district->districtname }}</td>
                                                                    {{-- morning --}}
                                                                    <td>
                                                                        {{-- weather --}}
                                                                        <select
                                                                            class="form-select form-select-sm weatherdetail required"
                                                                            ...
                                                                            <option value="SUNNY BREAKS">SUNNY BREAKS
                                                                            </option>
                                                                            <option value="SUNNY INTERVALS">SUNNY INTERVALS
                                                                            </option>
                                                                            <option value="FEW CLOUDS">FEW CLOUDS</option>
                                                                            <option value="PARTLY CLOUDY(DAY)">PARTLY
                                                                                CLOUDY(DAY)</option>
                                                                    ...
                                                                    <td>
                                                                        <div class="form-floating">
                                                                            <input type="number"
                                                                                ...
                                                                                id="{{ $district->districtname }}MfloatingInputtempmin{{ $district->id }}">
                                                                            <label
                                                                                for="{{ $district->districtname }}MfloatingInputtempmin{{ $district->id }}">Min
                                                                                Temperature</label>
                                                                        </div>
                                                                    </td>
                                                                    {{-- max temp --}}
                                                                    <td>
                                                                        <div class="form-floating">
                                                                            <input type="number"
                                                                                class="form-control required"
                                                                                id="{{ $district->districtname }}MfloatingInputtempmax{{ $district->id }}">
                                                                            <label
                                                                                for="{{ $district->districtname }}MfloatingInputtempmax{{ $district->id }}">Max
                                                                                Temperature</label>
                                                                        </div>
                                                                    </td>
                                                                    {{-- WIND --}}
                                                                    <td>
                                                                        <div class="form-floating">
                                                                            <input type="text"
                                                                                class="form-control required"
                                                                                id="morningfloatingInputwind{{ $district->id }}">
                                                                            <label
                                                                                for="morningfloatingInputwind{{ $district->id }}">Wind
                                                                                Dir & Speed</label>
                                                                        </div>
                                                                    </td>
                                                                    {{-- Chance of  Occurring --}}
                                                            ...
                                                            <tr class="morning"
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <select
                                                                        ...
                                                                        aria-label="Small select">
                                                                        <option
                                                                            value="{{ $morningtablevalues['weather'] }}">
                                                                            {{ $morningtablevalues['weather'] }} </option>
                                                                        ...
                                                                        {{-- <option value="-DRIZZLENIGHT">SLIGHT DRIZZLE(NIGHT)</option> --}}
                                                                        <option value="DRIZZLEDAY">MODERATE DRIZZLE(DAY)
                                                                        </option>
                                                                        {{-- <option value="DRIZZLENIGHT">MODERATE DRIZZLE(NIGHT)</option> --}}
                                                                        <option value="+DRIZZLEDAY">HEAVY DRIZZLE(DAY)
                                                                        </option>
                                                                ...
                                                                <td>
                                                                    <div class="form-floating">
                                                                        <input type="number"
                                                                            class="form-control required"
                                                                            id="{{ $district->districtname }}MfloatingInputtempmin{{ $district->id }}"
                                                                            value="{{ $morningtablevalues['min_temp'] }}">
                                                                        <label
                                                                            for="{{ $district->districtname }}MfloatingInputtempmin{{ $district->id }}">Min
                                                                            Temperature</label>
                                                                    </div>
                                                                ...
                                                                <td>
                                                                    <div class="form-floating">
                                                                        <input type="number"
                                                                            class="form-control required"
                                                                            id="{{ $district->districtname }}MfloatingInputtempmax{{ $district->id }}"
                                                                            value="{{ $morningtablevalues['max_temp'] }}">
                                                                        <label
                                                                            for="{{ $district->districtname }}MfloatingInputtempmax{{ $district->id }}">Max
                                                                            Temperature</label>
                                                                    </div>
                                                                ...
                                                                <td>
                                                                    <select class="form-select form-select-sm required"
                                                                        aria-label="Small select">
                                                                        <option
                                                                            value="{{ $morningtablevalues['rain_chance'] }}">
                                                                            {{ $morningtablevalues['rain_chance'] }}
                                                                        </option>
                                                                        <option value="0%">Select Chance of Occurring
                                                                        </option>
                                                                        <option value="0% - 10%">0% - 10%</option>
                                                                        <option value="10% - 20%">10% - 20%</option>
                                                                        <option value="20% - 30%">20% - 30%</option>
                                                                ...
                                                                <td>
                                                                    <select class="form-select form-select-sm required"
                                                                        aria-label="Small select">
                                                                        <option
                                                                            value="{{ $morningtablevalues['humidity'] }}">
                                                                            {{ $morningtablevalues['humidity'] }} </option>
                                                                        <option value="null">Select Humidity</option>
                                                                        <option value="0% - 10%">0% - 10%</option>
                                                                        <option value="10% - 20%">10% - 20%</option>
                                                                        <option value="20% - 30%">20% - 30%</option>
                                                    ...
                                                    <tr class="morning" districtnam="{{ $district->districtname }}">
                                                        ...
                                                        <td>
                                                            ...
                                                            <select
                                                                ...
                                                                <option value="FEW CLOUDS">FEW CLOUDS</option>
                                                                <option value="PARTLY CLOUDY(DAY)">PARTLY CLOUDY(DAY)
                                                                </option>
                                                                {{-- <option value="PARTLY CLOUDY(NIGHT)">PARTLY CLOUDY(NIGHT)</option> --}}
                                                                <option value="CLOUDY">CLOUDY</option>
                                                                {{-- <option value="CLEAR NIGHT">CLEAR NIGHT</option> --}}
                                                        ...
                                                        <td>
                                                            <select class="form-select form-select-sm required"
                                                                aria-label="Small select">
                                                                <option value="0%">Select Chance of Occurring</option>
                                    ...
                                    <thead class="thead-dark">
                                        <tr>
                                            ...
                                            <th colspan="7">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <label for="datetableAfternoon" class="form-label">Set
                                                            Date</label>
                                                        <input type="date" class="form-control required"
                                                            id="datetableAfternoon">
                                                        {{-- value="{{ !empty($genAfternoon)  ? $genAfternoon->date : '' }}"> --}}
                                                    </div>
                                                    <div class="col-6">
                                                        <label for="itdtableAfternoon" class="form-label">Set ITD
                                                            Position</label>
                                                        <input type="number" class="form-control required"
                                                            id="itdtableAfternoon" placeholder="e.g: 1"
                                                            value="{{ !empty($genAfternoon) ? $genAfternoon->itd : '' }}">
                                                    </div>
                                                    {{-- <div class="col-4">
                                                                ...
                                                                <tr class="afternoon"
                                                                    ...
                                                                    <td>
                                                                        <div class="form-floating">
                                                                            <input type="number"
                                                                                class="form-control required"
                                                                                id="{{ $district->districtname }}AfloatingInputtempmin{{ $district->id }}">
                                                                            <label
                                                                                for="{{ $district->districtname }}AfloatingInputtempmin{{ $district->id }}">Min
                                                                                Temperature</label>
                                                                        </div>
                                                                    </td>
                                                                    {{-- max temp --}}
                                                                    <td>
                                                                        <div class="form-floating">
                                                                            <input type="number"
                                                                                class="form-control required"
                                                                                id="{{ $district->districtname }}AfloatingInputtempmax{{ $district->id }}">
                                                                            <label
                                                                                for="{{ $district->districtname }}AfloatingInputtempmax{{ $district->id }}">Max
                                                                                Temperature</label>
                                                                        </div>
                                                                    </td>
                                                                    {{-- WIND --}}
                                                                    <td>
                                                                        <div class="form-floating">
                                                                            <input type="text"
                                                                                class="form-control required"
                                                                                id="afternoonfloatingInputwind{{ $district->id }}">
                                                                            <label
                                                                                for="afternoonfloatingInputwind{{ $district->id }}">Wind
                                                                                Dir & Speed</label>
                                                                        </div>
                                                                    </td>
                                                                    {{-- Chance of  Occurring --}}
                                                            ...
                                                            <tr class="afternoon"
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <select class="form-select form-select-sm required"
                                                                        aria-label="Small select">
                                                                        <option
                                                                            value="{{ $afternoontablevalues['weather'] }}">
                                                                            {{ $afternoontablevalues['weather'] }}</option>
                                                                        <option value="null">Select Weather</option>
                                                                        <option value="-TSRA">SLIGHT TSRA(-)</option>
                                                                        <option value="TSRA">MODERATE TSRA</option>
                                                                        <option value="+TSRA">HEAVY TSRA(+)</option>
                                                                ...
                                                                <td>
                                                                    <div class="form-floating">
                                                                        <input type="number"
                                                                            class="form-control required"
                                                                            id="{{ $district->districtname }}AfloatingInputtempmin{{ $district->id }}"
                                                                            value="{{ $afternoontablevalues['min_temp'] }}">
                                                                        <label
                                                                            for="{{ $district->districtname }}AfloatingInputtempmin{{ $district->id }}">Min
                                                                            Temperature</label>
                                                                    </div>
                                                                ...
                                                                <td>
                                                                    <div class="form-floating">
                                                                        <input type="text"
                                                                            class="form-control required"
                                                                            id="afternoonfloatingInputwind{{ $district->id }}"
                                                                            value="{{ $afternoontablevalues['wind'] }}">
                                                                        <label
                                                                            for="afternoonfloatingInputwind{{ $district->id }}">Wind
                                                                            Dir & Speed</label>
                                                                    </div>
                                                                ...
                                                                <td>
                                                                    <select class="form-select form-select-sm required"
                                                                        aria-label="Small select">
                                                                        <option
                                                                            value="{{ $afternoontablevalues['rain_chance'] }}">
                                                                            {{ $afternoontablevalues['rain_chance'] }}
                                                                        </option>
                                                                        <option value="0%">Select Chance of Occurring
                                                                        </option>
                                                                        <option value="0% - 10%">0% - 10%</option>
                                                                ...
                                                                <td>
                                                                    <select class="form-select form-select-sm required"
                                                                        aria-label="Small select">
                                                                        <option
                                                                            value="{{ $afternoontablevalues['humidity'] }}">
                                                                            {{ $afternoontablevalues['humidity'] }}
                                                                        </option>
                                                                        <option value="null">Select Humidity</option>
                                                                        <option value="0% - 10%">0% - 10%</option>
                                                                        <option value="10% - 20%">10% - 20%</option>
                                            ...
                                            <th colspan="7">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        ...
                                                        <input type="date" class="form-control required"
                                                            id="datetableEvening">
                                                        {{-- value="{{ !empty($genEvening)  ? $genEvening->date : '' }}"> --}}
                                                    </div>
                                                    <div class="col-6">
                                                        <label for="itdtableEvening" class="form-label">Set ITD
                                                            Position</label>
                                                        <input type="number" class="form-control required"
                                                            id="itdtableEvening" placeholder="e.g: 1"
                                                            value="{{ !empty($genEvening) ? $genEvening->itd : '' }}">
                                                    </div>
                                                                ...
                                                                <tr class="evening"
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <select class="form-select form-select-sm required"
                                                                            ...
                                                                            <option value="+TSRA">HEAVY TSRA(+)</option>
                                                                            {{-- <option value="-RAINDAY">SLIGHT RAIN(DAY)</option> --}}
                                                                            <option value="-RAINNIGHT">SLIGHT RAIN(NIGHT)
                                                                            </option>
                                                                            {{-- <option value="RAINDAY">MODERATE RAIN(DAY)</option> --}}
                                                                            <option value="RAINNIGHT">MODERATE RAIN(NIGHT)
                                                                            </option>
                                                                            {{-- <option value="+RAINDAY">HEAVY RAIN(DAY)</option> --}}
                                                                            <option value="+RAINNIGHT">HEAVY RAIN(NIGHT)
                                                                            </option>
                                                                            {{-- <option value="-DRIZZLEDAY">SLIGHT DRIZZLE(DAY)</option> --}}
                                                                            <option value="-DRIZZLENIGHT">SLIGHT
                                                                                DRIZZLE(NIGHT)</option>
                                                                            {{-- <option value="DRIZZLEDAY">MODERATE DRIZZLE(DAY)</option> --}}
                                                                            <option value="DRIZZLENIGHT">MODERATE
                                                                                DRIZZLE(NIGHT)</option>
                                                                            {{-- <option value="+DRIZZLEDAY">HEAVY DRIZZLE(DAY)</option> --}}
                                                                            <option value="+DRIZZLENIGHT">HEAVY
                                                                                DRIZZLE(NIGHT)</option>
                                                                            ...
                                                                            <option value="PARTLY CLOUDY(NIGHT)">PARTLY
                                                                                CLOUDY(NIGHT)</option>
                                                                            <option value="CLOUDY">CLOUDY</option>
                                                                            <option value="CLEAR NIGHT">CLEAR NIGHT
                                                                            </option>
                                                                        </select>
                                                                    </td>
                                                                    {{-- min  TEMPERATURE --}}
                                                                    <td>
                                                                        <div class="form-floating">
                                                                            <input type="number"
                                                                                class="form-control required"
                                                                                id="{{ $district->districtname }}EfloatingInputtempmin{{ $district->id }}">
                                                                            <label
                                                                                for="{{ $district->districtname }}EfloatingInputtempmin{{ $district->id }}">Min
                                                                                Temperature</label>
                                                                        </div>
                                                                    </td>
                                                                    {{-- max temp --}}
                                                                    <td>
                                                                        <div class="form-floating">
                                                                            <input type="number"
                                                                                class="form-control required"
                                                                                id="{{ $district->districtname }}EfloatingInputtempmax{{ $district->id }}">
                                                                            <label
                                                                                for="{{ $district->districtname }}EfloatingInputtempmax{{ $district->id }}">Max
                                                                                Temperature</label>
                                                                        </div>
                                                                    </td>
                                                                    {{-- WIND --}}
                                                                    <td>
                                                                        <div class="form-floating">
                                                                            <input type="text"
                                                                                class="form-control required"
                                                                                id="eveningfloatingInputwind{{ $district->id }}">
                                                                            <label
                                                                                for="eveningfloatingInputwind{{ $district->id }}">Wind
                                                                                Dir & Speed</label>
                                                                        </div>
                                                                    </td>
                                                                    {{-- Chance of  Occurring --}}
                                                            ...
                                                            <tr class="evening"
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <select class="form-select form-select-sm required"
                                                                        aria-label="Small select">
                                                                        <option
                                                                            value="{{ $eveningtablevalues['weather'] }}">
                                                                            {{ $eveningtablevalues['weather'] }} </option>
                                                                        <option value="null">Select Weather</option>
                                                                        <option value="-TSRA">SLIGHT TSRA(-)</option>
                                                                        <option value="TSRA">MODERATE TSRA</option>
                                                                        <option value="+TSRA">HEAVY TSRA(+)</option>
                                                                        ...
                                                                        {{-- <option value="-DRIZZLEDAY">SLIGHT DRIZZLE(DAY)</option> --}}
                                                                        <option value="-DRIZZLENIGHT">SLIGHT DRIZZLE(NIGHT)
                                                                        </option>
                                                                        {{-- <option value="DRIZZLEDAY">MODERATE DRIZZLE(DAY)</option> --}}
                                                                        <option value="DRIZZLENIGHT">MODERATE
                                                                            DRIZZLE(NIGHT)</option>
                                                                        {{-- <option value="+DRIZZLEDAY">HEAVY DRIZZLE(DAY)</option> --}}
                                                                        <option value="+DRIZZLENIGHT">HEAVY DRIZZLE(NIGHT)
                                                                        </option>
                                                                ...
                                                                <td>
                                                                    <div class="form-floating">
                                                                        <input type="number"
                                                                            class="form-control required"
                                                                            id="{{ $district->districtname }}EfloatingInputtempmin{{ $district->id }}"
                                                                            value="{{ $eveningtablevalues['min_temp'] }}">
                                                                        <label
                                                                            for="{{ $district->districtname }}EfloatingInputtempmin{{ $district->id }}">Min
                                                                            Temperature</label>
                                                                    </div>
                                                                ...
                                                                <td>
                                                                    <div class="form-floating">
                                                                        <input type="number"
                                                                            class="form-control required"
                                                                            id="{{ $district->districtname }}EfloatingInputtempmax{{ $district->id }}"
                                                                            value="{{ $eveningtablevalues['max_temp'] }}">
                                                                        <label
                                                                            for="{{ $district->districtname }}EfloatingInputtempmax{{ $district->id }}">Max
                                                                            Temperature</label>
                                                                    </div>
                                                                ...
                                                                <td>
                                                                    <select class="form-select form-select-sm required"
                                                                        aria-label="Small select">
                                                                        <option
                                                                            value="{{ $eveningtablevalues['rain_chance'] }}">
                                                                            {{ $eveningtablevalues['rain_chance'] }}
                                                                        </option>
                                                                        <option value="0%">Select Chance of Occurring
                                                                        </option>
                                                                        <option value="0% - 10%">0% - 10%</option>
                                                                ...
                                                                <td>
                                                                    <select class="form-select form-select-sm required"
                                                                        aria-label="Small select">
                                                                        <option
                                                                            value="{{ $eveningtablevalues['humidity'] }}">
                                                                            {{ $eveningtablevalues['humidity'] }}
                                                                        </option>
                                                                        <option value="null">Select Humidity</option>
                                                                        <option value="0% - 10%">0% - 10%</option>
                                                                        <option value="10% - 20%">10% - 20%</option>
                                                    ...
                                                    <tr class="evening" districtnam="{{ $district->districtname }}">
                                                        ...
                                                        <td>
                                                            ...
                                                            <select class="form-select form-select-sm required"
                                                                ...
                                                                {{-- <option value="DRIZZLEDAY">MODERATE DRIZZLE(DAY)</option> --}}
                                                                <option value="DRIZZLENIGHT">MODERATE DRIZZLE(NIGHT)
                                                                </option>
                                                                {{-- <option value="+DRIZZLEDAY">HEAVY DRIZZLE(DAY)</option> --}}
                                                                <option value="+DRIZZLENIGHT">HEAVY DRIZZLE(NIGHT)</option>
                                                                ...
                                                                {{-- <option value="FEW CLOUDS">FEW CLOUDS</option> --}}
                                                                {{-- <option value="PARTLY CLOUDY(DAY)">PARTLY CLOUDY(DAY)</option> --}}
                                                                <option value="PARTLY CLOUDY(NIGHT)">PARTLY CLOUDY(NIGHT)
                                                                </option>
                                                                <option value="CLOUDY">CLOUDY</option>
                                                                <option value="CLEAR NIGHT">CLEAR NIGHT</option>
                                                            </select>
                                                                ...
                                                                <tr class="evening"
                                                                    ...
                                                                    <td>
                                                                        <select
                                                                            class="form-select form-select-sm required"
                                                                            aria-label="Small select">
                                                                            <option value="null">Select Humidity
                                                                            </option>
                                                                            <option value="0% - 10%">0% - 10%</option>
                                                                            <option value="10% - 20%">10% - 20%</option>
                                                                            <option value="20% - 30%">20% - 30%</option>
                                    ...
                                    <thead class="thead-dark">
                                        <tr>
                                            ...
                                            <th colspan="7">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <label for="datetableMorning" class="form-label">Set
                                                            Date</label>
                                                        <input type="date" class="form-control required"
                                                            id="datetableMorning">
                                                        {{-- value="{{ !empty($genMorning)  ? $genMorning->date : '' }}"> --}}
                                                                ...
                                                                <tr class="morning"
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <select
                                                                            ...
                                                                            {{-- <option value="+RAINNIGHT">HEAVY RAIN(NIGHT)</option> --}}
                                                                            <option value="-DRIZZLEDAY">SLIGHT
                                                                                DRIZZLE(DAY)</option>
                                                                            {{-- <option value="-DRIZZLENIGHT">SLIGHT DRIZZLE(NIGHT)</option> --}}
                                                                            <option value="DRIZZLEDAY">MODERATE
                                                                                DRIZZLE(DAY)</option>
                                                                            ...
                                                                            <option value="SUNNY INTERVALS">SUNNY
                                                                                INTERVALS</option>
                                                                            <option value="FEW CLOUDS">FEW CLOUDS</option>
                                                                            <option value="PARTLY CLOUDY(DAY)">PARTLY
                                                                                CLOUDY(DAY)</option>
                                    ...
                                    <thead class="thead-dark">
                                        <tr>
                                            ...
                                            <th colspan="7">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <label for="datetableEvening" class="form-label">Set
                                                            Date</label>
                                                        <input type="date" class="form-control required"
                                                            id="datetableEvening">
                        ...
                        <div class="container  my-2">
                            ...
                            <div class="row">
                                <div class="d-flex justify-content-between bd-highlight my-2">
                                    <div></div>
                                    <button type="button" class="btn btn-success text-white" id="nextBtn2ndpage">Save
                                        and Continue</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="map" role="tabpanel" aria-labelledby="map-tab">
                        ...
                        <div class="alert alert-primary alert-dismissible fade show p-2 m-2" role="alert">
                            ...
                            <p>2. You add labels to the map or delete them using the add Rain and delete obiject buttons
                                respectively.</p>
                        </div>
                        <div class="card-group">
                          @if ($forecasttype == "Morning")
                            ...
                            <div class="card">
                                ...
                                <div class="d-grid gap-2 p-2">
                                    <div class="alert alert-warning fade show p-2 m-2" role="alert">
                                        <strong class="fs-3"> Morning Map</strong>
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="m-2 ">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-primary text-white" id="button1"
                                            typeofIcon="addRain">Add Rain</button>
                                        <button type="button"
                                        ...
                                        <ul class="dropdown-menu overflow-scroll"
                                            style="max-width: 260px; max-height: 160px;">
                                        ...
                                        <button type="button" class="btn btn-danger text-white mx-2"
                                            id="button2">Delete Object</button>
                                    </div>
                                    <br>
                                    <button type="button" class="btn btn-sm m-2 text-dark"
                                        id="yellow-color">Yellow</button>
                                    <button type="button" class="btn btn-sm m-2 text-white"
                                        id="red-color">Red</button>
                                    <button type="button" class="btn btn-sm m-2 text-white"
                                        id="green-color">Green</button>
                                    <button type="button" class="btn btn-sm m-2 text-white"
                                        id="orange-color">Orange</button>

                                </div>
                                {{-- </div> --}}
                                <div class="card-body"
                                    style="position: relative; width:100%;    min-height: 300px">
                                    <div id="mapAdmin1" style="width: 100%;  height: 100%;"> </div>
                                </div>
                            ...
                            <div class="card">
                                <div class="d-grid gap-2 p-2">
                                    <div class="alert alert-warning fade show p-2 m-2" role="alert">
                                        <strong class="fs-3">Afternoon Map</strong>
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="m-2 ">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-primary text-white" id="button1af"
                                            typeofIcon="addRainaf">Add Rain</button>
                                        <button type="button"
                                            class="btn btn-primary dropdown-toggle dropdown-toggle-split"
                                            data-bs-toggle="dropdown" aria-expanded="false">
                                            <span class="visually-hidden">Toggle Dropdown</span>
                                        ...
                                        <button type="button" class="btn btn-danger text-white mx-2"
                                            id="button2af">Delete Object</button>
                                    </div>
                                    <br>
                                    <button type="button" class="btn btn-sm m-2 text-dark"
                                        id="yellow-coloraf">Yellow</button>
                                    <button type="button" class="btn btn-sm m-2 text-white"
                                        id="red-coloraf">Red</button>
                                    <button type="button" class="btn btn-sm m-2 text-white"
                                        id="green-coloraf">Green</button>
                                    <button type="button" class="btn btn-sm m-2 text-white"
                                        id="orange-coloraf">Orange</button>

                                </div>
                                {{-- </div> --}}
                                <div class="card-body"
                                    style="position: relative; width:100%;   min-height: 300px">
                                    <div id="mapAdmin1af"  style="  width: 100%; height: 100%;"> </div>
                                </div>
                                <div class="card-footer">
                            ...
                            <div class="card">
                                <div class="d-grid gap-2 p-2">
                                    <div class="alert alert-warning fade show p-2 m-2" role="alert">
                                        <strong class="fs-3">Evening Map</strong>
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="m-2 ">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-primary text-white" id="button1ev"
                                            typeofIcon="addRainev">Add Rain</button>
                                        <button type="button"
                                            class="btn btn-primary dropdown-toggle dropdown-toggle-split"
                                            data-bs-toggle="dropdown" aria-expanded="false">
                                            <span class="visually-hidden">Toggle Dropdown</span>
                                        ...
                                        <button type="button" class="btn btn-danger text-white mx-2"
                                            id="button2ev">Delete Object</button>
                                    </div>
                                    <br>
                                    <button type="button" class="btn btn-sm m-2 text-dark"
                                        id="yellow-colorev">Yellow</button>
                                    <button type="button" class="btn btn-sm m-2 text-white"
                                        id="red-colorev">Red</button>
                                    <button type="button" class="btn btn-sm m-2 text-white"
                                        id="green-colorev">Green</button>
                                    <button type="button" class="btn btn-sm m-2 text-white"
                                        id="orange-colorev">Orange</button>

                                </div>
                                {{-- </div> --}}
                                <div class="card-body"
                                    style="position: relative; width:100%;  min-height: 300px">
                                    <div id="mapAdmin1ev" style="  width: 100%; height: 100%;"> </div>
                                </div>
                                <div class="card-footer">
                       ...
                       <div class="card">
                        ...
                        <div class="container my-2">
                            ...
                            <div class="row">
                                <div class="d-flex justify-content-between bd-highlight my-2">
                                    <div> </div>
                                    <button type="button" class="btn btn-success text-white" id="nextBtn3rdpage">Save
                                        and Continue</button>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="card text-white">
                                    <img class="card-img-top" src="{{ asset('images/warning.png') }}"
                                        style="height: 200px;" alt="Title">
                                </div>
                            </div>
                            <div class="col-9">
                                <div class="card text-white">
                    ...
                    {{-- Weather Summary --}}
                    <div class="tab-pane fade" id="weatherSummary" role="tabpanel"
                        aria-labelledby="weatherSummary-tab">
                        <div class="container">
                            <div class="row">
                                <div class="d-flex justify-content-between bd-highlight mb-2">
                                    <div></div>
                                    <button type="button" class="btn btn-success text-white" id="nextBtn4thpage">Save
                                        and Continue</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="alert alert-warning alert-dismissible fade show p-2 m-2" role="alert">
                            <button type="button" class="btn-close" data-bs-dismiss="alert"
                                aria-label="Close"></button>
                            <strong> Weather Summary Report</strong>
                        </div>

                        <div class="form-floating my-3">

                            <textarea class="form-control" placeholder="Write your weather here" id="floatingTextareaSummary"
                    ...
                    {{--  WeatherWarning --}}
                    <div class="tab-pane fade " id="weatherWarning" role="tabpanel"
                        aria-labelledby="weatherWarning-tab">
                        <div class="container">
                            <div class="row">
                                <div class="d-flex justify-content-between bd-highlight mb-2">
                                    <div></div>
                                    ...
                                    <div>
                                        <button type="button" class="btn btn-primary text-white " id="buttonpublish"
                                            typeofSubmit="Publish-Forecast">Publish-Forecast</button>
                                        <button type="button"
                                            class="btn btn-primary dropdown-toggle dropdown-toggle-split"
                                            data-bs-toggle="dropdown" aria-expanded="false">
                                            <span class="visually-hidden">Toggle Dropdown</span>
                                        ...
                                        <ul class="dropdown-menu overflow-scroll"
                                            style="max-width: 260px; max-height: 160px;">
                                            <li><a class="dropdown-item publ" id="Publish-Forecast">Publish-Forecast</a>
                                            </li>
                                            <li><a class="dropdown-item publ" id="Draft-Forecast">Draft-Forecast</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="alert alert-danger alert-dismissible fade show p-2 m-2" role="alert">
                            <button type="button" class="btn-close" data-bs-dismiss="alert"
                                aria-label="Close"></button>
                            <strong> Weather Warning Forecast</strong>
                        </div>
                        ...
                        <div class="form-floating my-3">
                            ...
                            <textarea class="form-control" placeholder="Write your weather warning here" id="textareaweatherwarning"
                                style="height: 150px"></textarea>
