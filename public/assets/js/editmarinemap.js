...
var nextBtn2 = document.getElementById('mapupdate');



function savetoDatabase(masterContainer){
  if(masterContainer){
  var pubBtn =  document.getElementById('mapupdate');
...
const xhr = new XMLHttpRequest();
  xhr.open('post', '/admin/editmarinemap', true);
...
var map = new mapboxgl.Map({
  container: 'marineMapAdminEdit', // container id
...
nextBtn2.addEventListener('click', function(e) {
    var id = document.querySelector("#iddd").value;
var date = document.querySelector("#validAt").value;
