...
// =================table page next button for addnew MARINE forecast==========
var nextBtn2 = document.getElementById('nextBtn2ndpageM');



function savetoDatabase(masterContainer){
  if(masterContainer){
  var pubBtn =  document.getElementById('nextBtn2ndpageM');
...
const xhr = new XMLHttpRequest();
  xhr.open('post', 'addmarineforecastpost', true);
  ...
  xhr.onload = () => {
    if (xhr.readyState === 4 && xhr.status === 200) {
      ...
      window.location.href = "/admin/marineforecast";
...
var map = new mapboxgl.Map({
  container: 'marineMapAdmin', // container id
...
map.resize();
map.on('render', function(){map.resize();});
...
function changeColor(color) {
  if (drawFeatureID !== '' && typeof draw === 'object') {
    ...
    //   console.log(feat);
      draw.add(feat)
// on change of  color, update the polygons  array
var drawId = feat.id;
if (polygons.length === 0) {
    ...
    var index = polygons.findIndex(function(item) {
...
// ===============END OF MARINE  MAP  PAGE=========================


nextBtn2.addEventListener('click', function(e) {
  // get the form details:
  const validAt = document.querySelector('#validAt').value;
  const seaState = document.querySelector('#seaState').value;
  const maxWaveCurrentRange = document.querySelector('#maxWaveCurrentRange').value;
  const surfaceWind24hrsMin = document.querySelector('#surfaceWind24hrsMin').value;
  const surfaceWind24hrsMax = document.querySelector('#surfaceWind24hrsMax').value;
  const surfaceWind48hrsMin = document.querySelector('#surfaceWind48hrsMin').value;
  const surfaceWind48hrsMax = document.querySelector('#surfaceWind48hrsMax').value;
  const visibility24hrsMin = document.querySelector('#visibility24hrsMin').value;
  const visibility24hrsMax = document.querySelector('#visibility24hrsMax').value;
  const visibility48hrsMin = document.querySelector('#visibility48hrsMin').value;
  const visibility48hrsMax = document.querySelector('#visibility48hrsMax').value;
  const seaSurfTemp24hrsMin = document.querySelector('#seaSurfTemp24hrsMin').value;
  const seaSurfTemp24hrsMax = document.querySelector('#seaSurfTemp24hrsMax').value;
  const seaSurfTemp48hrsMin = document.querySelector('#seaSurfTemp48hrsMin').value;
  const seaSurfTemp48hrsMax = document.querySelector('#seaSurfTemp48hrsMax').value;
  const sigWaveHeight24hrsMin = document.querySelector('#sigWaveHeight24hrsMin').value;
  const sigWaveHeight24hrsMax = document.querySelector('#sigWaveHeight24hrsMax').value;
  const sigWaveHeight48hrsMin = document.querySelector('#sigWaveHeight48hrsMin').value;
  const sigWaveHeight48hrsMax = document.querySelector('#sigWaveHeight48hrsMax').value;
  const tidalwave24hrsMin = document.querySelector('#tidalwave24hrsMin').value;
  const tidalwave24hrsMax = document.querySelector('#tidalwave24hrsMax').value;
  const tidalwave48hrsMin = document.querySelector('#tidalwave48hrsMin').value;
  const tidalwave48hrsMax = document.querySelector('#tidalwave48hrsMax').value;
  const waveCureent24hrs = document.querySelector('#waveCureent24hrs').value;
  const waveCureent48hrs = document.querySelector('#waveCureent48hrs').value;
  const summary = document.querySelector('#summaryMarine').value;
  ...
  masterContainer.push({
      'dateWaveCurrent' : [validAt,maxWaveCurrentRange,seaState],
      'tableValues': {
        "surfaceWind24hrsMin": surfaceWind24hrsMin,
       "surfaceWind24hrsMax" : surfaceWind24hrsMax,
       "surfaceWind48hrsMin": surfaceWind48hrsMin,
       "surfaceWind48hrsMax" : surfaceWind48hrsMax,
       "visibility24hrsMin": visibility24hrsMin,
       "visibility24hrsMax" : visibility24hrsMax,
       "visibility48hrsMin": visibility48hrsMin,
       "visibility48hrsMax" : visibility48hrsMax,
       "seaSurfTemp24hrsMin": seaSurfTemp24hrsMin,
       "seaSurfTemp24hrsMax" : seaSurfTemp24hrsMax,
       "seaSurfTemp48hrsMin": seaSurfTemp48hrsMin,
       "seaSurfTemp48hrsMax" : seaSurfTemp48hrsMax,
       "sigWaveHeight24hrsMin": sigWaveHeight24hrsMin,
       "sigWaveHeight24hrsMax" : sigWaveHeight24hrsMax,
       "sigWaveHeight48hrsMin": sigWaveHeight48hrsMin,
       "sigWaveHeight48hrsMax" : sigWaveHeight48hrsMax,
       "tidalwave24hrsMin": tidalwave24hrsMin,
       "tidalwave24hrsMax" : tidalwave24hrsMax,
       "tidalwave48hrsMin": tidalwave48hrsMin,
       "tidalwave48hrsMax" : tidalwave48hrsMax,
       "waveCureent24hrs" : waveCureent24hrs,
       "waveCureent48hrs" : waveCureent48hrs,
      },
      'summary' : summary,
