// addinlandforecast page intro animation
const boat = document.querySelector('.boats');
let boatLeft = 10;
...
// ====INLAND-FORECAST JS HERE===========INLAND-FORECAST JS HERE===========INLAND-FORECAST JS HERE===================
// Initialize an empty array to store the grouped values
const inlandmorningValues = [];
const inlandafternoonValues = [];
const inlandeveningValues = [];
const inlandmasterContainer = [];
// =================table page next button for addnew daily forecast==========
var nextBtn2 = document.getElementById('inlandnextBtn2ndpage');
...
const inlandDatetableMorning = document.querySelector('#inlandDatetableMorning').value;
const minTemptableMorning = document.querySelector('#minTemptableMorning').value;
const maxTemptableMorning = document.querySelector('#maxTemptableMorning').value;
// const prestableMorning = document.querySelector('#prestableMorning').value;

const inlandDatetableAfternoon = document.querySelector('#inlandDatetableAfternoon').value;
const minTemptableAfternoon = document.querySelector('#minTemptableAfternoon').value;
const maxTemptableAfternoon = document.querySelector('#maxTemptableAfternoon').value;

// const prestableAfternoon = document.querySelector('#prestableAfternoon').value;


const inlandDatetableEvening = document.querySelector('#inlandDatetableEvening').value;
const minTemptableEvening = document.querySelector('#minTemptableEvening').value;
const maxTemptableEvening = document.querySelector('#maxTemptableEvening').value;


// 

function inlandforecastvalidatetableForm() {
...
morningDivs.forEach(div => {
  ...
  inlandmorningValues.push(divData);
});
...
// ===========================afternoon table===================================
 ...
 afternoonDivs.forEach(div => {
   ...
   inlandafternoonValues.push(divData);
 });
...
// ===========================evening table===================================
 ...
 eveningDivs.forEach(div => {
   ...
   inlandeveningValues.push(divData);
 });

var inlandforecastallfieldsfilled = inlandforecastvalidatetableForm();

if(inlandforecastallfieldsfilled == true){
 if (inlandmasterContainer.length === 0) {
// Print the grouped values for testing
inlandmasterContainer.push({
    'dateMinMaxTempValues' : [inlandDatetableMorning,minTemptableMorning,maxTemptableMorning,inlandDatetableAfternoon, minTemptableAfternoon,maxTemptableAfternoon, inlandDatetableEvening, minTemptableEvening,maxTemptableEvening],
    'tableValues': {"inlandmorningValues": inlandmorningValues, "inlandafternoonValues" : inlandafternoonValues, 'inlandeveningValues' : inlandeveningValues},
    'mapdates' : '' ,
    'markers': '',
    'polygons': '' ,
    'summary' : '',
...
let keyToReplace = 'dateMinMaxTempValues'; 
let keyToReplace2 = 'tableValues'; 
// Check if the array has the specified key
let index = inlandmasterContainer.findIndex(obj => obj.hasOwnProperty(keyToReplace));
// Check if the array has the specified key
let index2 = inlandmasterContainer.findIndex(obj => obj.hasOwnProperty(keyToReplace2));
// If the key is found, replace the value
if (index !== -1) {
    inlandmasterContainer[index][keyToReplace] = [inlandDatetableMorning,minTemptableMorning,maxTemptableMorning,inlandDatetableAfternoon, minTemptableAfternoon, maxTemptableAfternoon, inlandDatetableEvening, minTemptableEvening,maxTemptableEvening ];
  }
  
// If the key is found, replace the value
if (index2 !== -1) {
    inlandmasterContainer[index][keyToReplace2] = {"inlandmorningValues": inlandmorningValues, "inlandafternoonValues" : inlandafternoonValues, 'inlandeveningValues' : inlandeveningValues};
  }
}

console.log([inlandDatetableMorning,minTemptableMorning,maxTemptableMorning,inlandDatetableAfternoon, minTemptableAfternoon, maxTemptableAfternoon, inlandDatetableEvening, minTemptableEvening,maxTemptableEvening]);
console.log({"inlandmorningValues": inlandmorningValues, "inlandafternoonValues" : inlandafternoonValues, 'inlandeveningValues' : inlandeveningValues});

console.log("master:", inlandmasterContainer)
...
// ===============END OF MORNING  MAP FOR ADDINLANDFORECAST PAGE=========================


// ===============afternoon MAP FOR ADDINLANDFORECAST PAGE=========================

mapboxgl.accessToken = 'pk.eyJ1IjoidGhlbzYiLCJhIjoiY2xmazRpa2VzMDdiZDN0czR5Z2tiMGxheCJ9.GMZxHYFG0rGU8R6133k1kg';
var mapaf = new mapboxgl.Map({
  container: 'inlandmapAdmin1af', // container id
  style: 'mapbox://styles/mapbox/streets-v9', //hosted style id
  zoom: 6,
  center: [-0.3,7.915],
});
...
function updateMarkerPositionaf(markeraf, lngLat) {
  ...
  // Add an event listener to the button to create a new marker
document.getElementById('inlandbutton1af').addEventListener('click', function() {
...
var addiconaf = document.querySelector("#inlandbutton1af");
svgIconsaf.forEach(function(svgIconaf) {
 ...
 // Add an event listener to the button to remove the selected marker
 document.getElementById('inlandbutton2af').addEventListener('click', function() {
...
// ===============END OF afternoon MAP FOR ADDINLANDFORECAST PAGE=================================================



// ===============EVENING MAP FORADDINLANDFORECAST PAGE=========================

mapboxgl.accessToken = 'pk.eyJ1IjoidGhlbzYiLCJhIjoiY2xmazRpa2VzMDdiZDN0czR5Z2tiMGxheCJ9.GMZxHYFG0rGU8R6133k1kg';
var mapev = new mapboxgl.Map({
  container: 'inlandmapAdmin1ev', // container id
  style: 'mapbox://styles/mapbox/streets-v9', //hosted style id
  zoom: 6,
  center: [-0.3,7.915],
});
...
function updateMarkerPositionev(markerev, lngLat) {
  ...
  // Add an event listener to the button to create a new marker
document.getElementById('inlandbutton1ev').addEventListener('click', function() {
...
var addiconev = document.querySelector("#inlandbutton1ev");
svgIconsev.forEach(function(svgIconev) {
 ...
 // Add an event listener to the button to remove the selected marker
 document.getElementById('inlandbutton2ev').addEventListener('click', function() {
...
// ===============END OF EVENING MAP FORADDINLANDFORECAST PAGE=========================
...
var nextBtn4 = document.getElementById('inlandnextBtn4thpage');
nextBtn4.addEventListener('click', function(e) {
  ...
  function validatesummary() {
    // Get all required input and select elements
    let requiredElements = document.querySelectorAll('#inlandfloatingTextareaSummary');
...
var validatesummaryn= validatesummary();
  ...
  const summary = document.querySelector('#inlandfloatingTextareaSummary').value;
  ...
  if (inlandmasterContainer.length === 0) {
    ...
    if (index !== -1) {
        inlandmasterContainer[index][keyToReplace] =   summary;
      }   }

console.log(summary);
console.log("masterSummary:", inlandmasterContainer);
  activeNav.classList.remove('active');
  nextNav.classList.add('active');
  nextNav.classList.remove('disabled');
...
var publs = document.querySelectorAll('.inlandpubl');
var changepubType = document.querySelector("#inlandbuttonpublish");
publs.forEach(function(inlandpubl) {
    inlandpubl.addEventListener('click', function() {
    var id = this.id;
    var content = this.textContent.trim();
...
var inlandbuttonpublish = document.getElementById('inlandbuttonpublish');
inlandbuttonpublish.addEventListener('click', function(e) {
// Retrieve the value of the custom attribute
...
const schdate = document.getElementById('schedule-date').value;
 ...
 if (inlandmasterContainer.length === 0) {
    ...
    var index3 = inlandmasterContainer.findIndex(obj => obj.hasOwnProperty(keyToReplace3));
     // Check if the array has the specified key
     var index4 = inlandmasterContainer.findIndex(obj => obj.hasOwnProperty(keyToReplace4));
    
    if (index !== -1) {
        inlandmasterContainer[index][keyToReplace] =  publishType;
      }   
      if (index !== -1) {
        inlandmasterContainer[index2][keyToReplace2] =   textareaweatherwarning;
      }   
      if (index !== -1) {
        inlandmasterContainer[index3][keyToReplace3] =   warningtype;
      }   
      if (index !== -1) {
        inlandmasterContainer[index4][keyToReplace4] =   schdate ;
      }   
    }



savetoDatabase(inlandmasterContainer);


});

// 
 function savetoDatabase(inlandmasterContainer){
    if(inlandmasterContainer){
    var pubBtn =  document.getElementById('inlandbuttonpublish');
    pubBtn.innerHTML = '<div class="spinner-border spinner-border-sm" role="status"><span class="visually-hidden">Loading...</span></div>';


  var jsonData = JSON.stringify(inlandmasterContainer);
  const xhr = new XMLHttpRequest();
    xhr.open('post', 'addinlandforecastpost', true);
    ...
    xhr.onload = () => {
      if (xhr.readyState === 4 && xhr.status === 200) {
        ...
        window.location.href = "/admin/inlandforecast";
    ...
    console.log("MMMMMMMMMMMMMMMMMMMmaster:", inlandmasterContainer[0]);
}
