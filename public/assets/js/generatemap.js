...
var mapM = new mapboxgl.Map({
  container: 'morningMap',
  style: 'mapbox://styles/mapbox/light-v10',  // 'mapbox://styles/mapbox/streets-v9', //hosted style id
  zoom: 4.9,
  center: [-1.03,7.915],
...
new mapboxgl.Marker(svgMarker).setLngLat([obj.markerslnglat.lng, obj.markerslnglat.lat])
  .addTo(mapA);
